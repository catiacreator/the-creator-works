...
export default function ChatPage() {
  ...
  // /chat?thread=… — para o ecrã Criar poder abrir a conversa que acabou de criar,
  // e para o endereço de uma conversa continuar a funcionar depois de recarregar.
  useEffect(() => {
    const ler = () => setThreadId(new URLSearchParams(window.location.search).get('thread'));
    ler();
